  ...
  if(correct === Math.min(totalMatchingPairs, totalDraggableItems)) { // Game Over!!
    ...
    setTimeout(() => {
        Swal.fire({
            ...
            text: 'VIDRO É UM TIPO DE MATERIAL USADO PARA PRODUZIR DIVERSOS PRODUTOS, COMO A JARRA DA FOTO. O VIDRO É TRANSPARENTE E DURO.',
        }).then(function() {
            location.replace("pagina7.html");
        });
    }, 200);
  }
