  ...
  if(correct === Math.min(totalMatchingPairs, totalDraggableItems)) { // Game Over!!
    ...
    setTimeout(() => {
        Swal.fire({
            ...
            text: 'A LÂMPADA MOSTRADA NA FOTO É FEITA DE VIDRO. ESSE MATERIAL  É DURO E TRANSPARENTE E, NESSE CASO, POSSIBILITA QUE A LUZ ILUMINE O AMBIENTE. ',
        }).then(function() {
            location.replace("pagina10.html");
        });
    }, 200);
  }
